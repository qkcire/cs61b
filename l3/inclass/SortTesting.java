...
public class SortTesting {
    /** Copy INPUT into data and run Sort.sort
     *  on it. Returns the result. */
    private String[] runSort(String[] input,
                             int L,
                             int U) {
    ...
    public void reverseTest() {
        assertArrayEquals("Reverse test failed",
                          ...
                          runSort(new String[] { "red", "green", "blue"}, 0, 2));
    }
}
