...
class increment {
     ...
     *  1. First, print L
     *  2. Print L incremented non-destructively
     *     by N.
     *  3. Print L again (to see that it has not
     *     changed).
     *  4. Print L incremented destructively by N.
     *  5. Print L again (to see that it HAS
     *     changed).
     */
    ...
    /* Alternative, iterative, implementation of
       dincrList: */
